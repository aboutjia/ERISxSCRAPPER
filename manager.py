...
def banner():
    ...
    b = [
    ' ‌ٖٖٖٖٖٖٜٖٖٖٖٖٖٜٖٖٖٖٖٖٜٖٖٖٖٖٖٜٖٖٖٖٖٖ𓆩🖤𓆪ــــﮩــ٨ﮩﮩ𝑬𝑹𝑰𝑺 𝒙 𝑺𝑪𝑹𝑨𝑷𝑷𝑬𝑹ﮩﮩ٨ــﮩــــ𓆩🖤𓆪 ‌ٖٖٖٖٖٖٜٖٖٖٖٖٖٜٖٖٖٖٖٖٜٖٖٖٖٖٖٜٖٖٖٖٖٖ',

    ]
    for char in b:
        print(f'{random.choice(colors)}{char}{rs}')
    #print('=============SON OF KING==============')
    print(f'{lg}   Version: {w}1.2{lg} | Author: {w}Anonymous{rs}\n')
...
while True:
    ...
    print(lg+'[4] Update your Anonymous Scraper'+n)
    print(lg+'[5] Quit'+n)
    a = int(input('\nEnter your choice: '))
    if a == 1:
        new_accs = []
        ...
        try:
            # https://raw.githubusercontent.com/Itz-UNKOWN-xd/ERISxSCRAPPER/main/version.txt
            version = requests.get('https://raw.githubusercontent.com/Itz-UNKOWN-xd/ERISxSCRAPPER/main/version.txt')
        except:
        ...
        if float(version.text) > 1.1:
            ...
            if prompt == 'y' or prompt == 'yes' or prompt == 'Y':
                ...
                os.system('curl -l -O https://raw.githubusercontent.com/Itz-UNKOWN-xd/ERISxSCRAPPER/main/version.txt')
                os.system('curl -l -O https://raw.githubusercontent.com/Itz-UNKOWN-xd/ERISxSCRAPPER/main/version.txt')
            ...
            print(f'{lg}[i] Your Anonymous Scraper is already up to date')
